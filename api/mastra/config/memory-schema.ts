 ...
 */
export function isEligibleForPromotion(fact: LearnedFact): boolean {
  ...
  return (
    confidence >= PROMOTION_THRESHOLDS.minConfidence &&
 ...
 */
export function getPromotionCandidates(profile: Partial<UserProfile>): LearnedFact[] {
