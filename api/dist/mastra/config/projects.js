...
export function getProjectByChannel(channelName) {
    ...
    return projectConfigs.find(p => p.channelPatterns.some(pattern => lowerName.includes(pattern.toLowerCase())));
}
/**
 * プロジェクトIDからプロジェクトを取得
 */
 ...
 */
export function getAirtableConfigByChannel(channelName) {
